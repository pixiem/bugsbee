              ...
              <Col md={12} lg={12}>
                <div className="sec-title">
                 <center> <h2>
                  ...
                  <h5 className="mt-5">Bugs Bee, a dedicated digital agency, is now among one of the leading ones currently operating globally. It offers a vast amount of digital products ensuring the use of up-to-date tools, optimized to be most efficient for its clients. From designing simple apps to creating whole robust Web Applications, rest assured, cause we got you covered! We have a bunch of specialized Programmers and IT Professionals improvised just to meet your needs!</h5>
                </div>
              </Col>
              {/* <Col md={12} lg={4}>
